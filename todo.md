...
- [ ] P0 priority 2: add a unified Fleet Manager triage queue combining driver issues, expiring documents, open work, and low-stock signals with acknowledge, assign, defer, and resolve actions.
