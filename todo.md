...
- [ ] Prepare Razorpay Test Mode integration without live charges: test-only credentials, webhook signature verification, subscription/payment event mapping, and an explicit production/live-mode guard; registered-company activation is not required for this development phase.
