...
- [ ] Add an authorized edit action for existing Fleet Manager work orders so an unassigned order can later receive or change a mechanic, with tenant validation, audit coverage, GitHub synchronization, and Vercel deployment.
