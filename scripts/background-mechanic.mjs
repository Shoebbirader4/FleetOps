...
try {
  ...
  await check("Mechanic completes assigned work order with execution record", () => tRPC("workOrders.complete", mechanicToken, { workOrderId, laborHours: 2.5, repairNotes: "Replaced worn belt and verified engine idle.", evidence: [{ fileData: evidence, contentType: "image/png", fileName: "repair-proof.png", caption: "After repair" }], parts: [{ partId, qtyUsed: 1 }] }));
