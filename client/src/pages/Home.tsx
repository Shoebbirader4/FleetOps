    ...
    <div className="app-shell">
      ...
      <main className="main-canvas">
        ...
        <section className="page-content">
          ...
          <footer className="page-footer"><span><span className="footer-pulse" /> {authLoading ? "Connecting Supabase Auth" : "Supabase Auth + Realtime connected"}</span><span>Live query result · {liveActivity?.length ?? 0} events</span><span>© FleetOps / {backendSummary?.org.name ?? "FleetOps"}</span></footer>
        </section>
      </main>
    </div>
  );
